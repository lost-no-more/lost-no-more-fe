...
export default function Headerbar() {
  return (
    ...
    >
      <Link data-cid="Link-waa9oc" href="/">
        <LogoIcon data-cid="LogoIcon-X8lHER" width={50} height={50} fill="hsl(var(--background))" />
      </Link>
      <Searchbar data-cid="Searchbar-ESeM7f" />
      <div data-cid="div-H1S0NG" className="flex items-center gap-4">
